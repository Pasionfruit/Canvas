...
namespace App.LearningManagement.Helpers
{
	public class CourseHelper
	{
        ...
        {
            Console.WriteLine("Enter the student to add to the course:");
            courseService.Courses.ForEach(Console.WriteLine);
            var selection = Console.ReadLine();
        ...
        {
            Console.WriteLine("Enter the code of the course to add the assignment:");
            courseService.Courses.ForEach(Console.WriteLine);
            var selection = Console.ReadLine();
        ...
        public void AddSubmission()
        {
            ...
            if (selectedCourse != null)
            {
                ...
                var selectedStudent = selectedCourse.Roster.Where(r => r is Student).FirstOrDefault(s => s.Id == selectedStudentId);
        ...
        {
            Console.WriteLine("Enter the code of the course to add the module:");
            courseService.Courses.ForEach(Console.WriteLine);
            var selection = Console.ReadLine();
        ...
        {
            Console.WriteLine("Enter the code of the course to add the announcement:");
            courseService.Courses.ForEach(Console.WriteLine);
            var selection = Console.ReadLine();
        ...
        {
            Console.WriteLine("Enter the code of the course to remove the module:");
            courseService.Courses.ForEach(Console.WriteLine);
            var selection = Console.ReadLine();
        ...
        {
            Console.WriteLine("Enter the code of the course to update the module:");
            courseService.Courses.ForEach(Console.WriteLine);
            var selection = Console.ReadLine();
            var selectedCourse = courseService.Courses.FirstOrDefault(s => s.Code.Equals(selection, StringComparison.InvariantCultureIgnoreCase));
        ...
        {
            Console.WriteLine("Enter the code of the course to update the assignment:");
            courseService.Courses.ForEach(Console.WriteLine);
            var selection = Console.ReadLine();
        ...
        {
            Console.WriteLine("Enter the code of the course to remove the assignment:");
            courseService.Courses.ForEach(Console.WriteLine);
            var selection = Console.ReadLine();
        ...
        {
            Console.WriteLine("Enter the code of the course to remove the announcement:");
            courseService.Courses.ForEach(Console.WriteLine);
            var selection = Console.ReadLine();
        ...
        {
            Console.WriteLine("Enter the code of the course to update the announcement:");
            courseService.Courses.ForEach(Console.WriteLine);
            var selection = Console.ReadLine();
        ...
        public void UpdateSubmission()
        {
            ...
            {
                selectedCourse.Submissions.ForEach(Console.WriteLine);
                var slectedId = int.Parse(Console.ReadLine() ?? "0");

                Console.WriteLine("Eter new content:");
                selectedCourse.Submissions.FirstOrDefault(a => a.Id == slectedId).Content = Console.ReadLine() ?? string.Empty;
            }
        }
        ...
        public void GradeSubmission(){
            ...
            var selectedCourse = courseService.Courses.FirstOrDefault(s => s.Code.Equals(selection, StringComparison.InvariantCulture));
            if (selectedCourse != null)
            {
                selectedCourse.Submissions.ForEach(Console.WriteLine);
                var selectedId = int.Parse(Console.ReadLine() ?? "0");
        ...
        public void GetStudentGrade()
        {
            ...
            if (selectedCourse != null)
            {
                Console.WriteLine("Enter the id for the stuent:");
