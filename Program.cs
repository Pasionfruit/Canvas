...
namespace MyApp
{
    internal class Program
    {
        ...
        static void ShowStudentMenu(StudentHelper studentHelper)
        {
            ...
            Console.WriteLine("1. Add a person enrollment");      
            Console.WriteLine("2. Update a person enrollment");    
            Console.WriteLine("3. List all enrolled people");     
        ...
        static void ShowCourseMenu(CourseHelper courseHelper)
        {
            ...
            Console.WriteLine("14. Add a Module to a courses");
            ...
            Console.WriteLine("18. Delete an announcement to a course");
            Console.WriteLine("19. Update an announcement");
